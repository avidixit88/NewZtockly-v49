...
if "heavenly_1m_cache" not in st.session_state:
    # {SYM: {"ts": float, "df": DataFrame}}
    st.session_state.heavenly_1m_cache = {}
    ...
    if scan_now or auto_refresh:
        ...
        if enable_heavenly:
            ...
            def _get_1m(symbol: str) -> pd.DataFrame:
                ...
                c = st.session_state.heavenly_1m_cache.get(symbol)
                ...
                st.session_state.heavenly_1m_cache[symbol] = {"ts": now_ts, "df": df1}
                return df1
